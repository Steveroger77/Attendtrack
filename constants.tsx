...
export const STATUS_STYLES: { [key in AttendanceStatus]: { color: string, short: string, label: string } } = {
  [AttendanceStatus.PRESENT]: { color: 'bg-green-500/20 text-green-300 border-green-500/30', short: 'P', label: 'Present' },
  [AttendanceStatus.ABSENT]: { color: 'bg-red-500/20 text-red-300 border-red-500/30', short: 'A', label: 'Absent' },
  [AttendanceStatus.LATE]: { color: 'bg-yellow-500/20 text-yellow-300 border-yellow-500/30', short: 'L', label: 'Late' },
  [AttendanceStatus.EXCUSED]: { color: 'bg-blue-500/20 text-blue-300 border-blue-500/30', short: 'E', label: 'Excused' },
};
...
export const ICONS = {
  ...
  assignments: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M8.684 13.342C8.886 12.938 9 12.482 9 12s-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.368a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z" /></svg>,
  inbox: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0l-8 5-8-5" /></svg>,
  ...
  megaphone: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-2.236 9.168-5.514C18.378 1.18 17.76.5 17.032.5H6.968c-.728 0-1.346.68-1.148 1.382A4.001 4.001 0 017 6v1.832c0 .927-.368 1.828-.968 2.484A4.001 4.001 0 015.436 13.683z" /></svg>,
  ...
  export: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg>,
